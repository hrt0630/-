...
<head>
    ...
    <style>
        ...
        .login-input { width: 100%; height: 55px; border-radius: 15px; border: 1px solid var(--border); background: rgba(255,255,255,0.08); color: white; padding: 0 20px; margin-bottom: 12px; box-sizing: border-box; }
        ...
        .index-item { background: rgba(255,255,255,0.06); padding: 25px; border-radius: 20px; margin-bottom: 18px; cursor: pointer; transition: 0.3s; }
    ...
    <div class="scene" id="scene">
        <div class="page-panel">
            <div id="left-default" class="layer show">
                ...
                <p style="opacity: 0.6; line-height: 1.8;">すみれさん、今日は「展開」と「因数分解」をマスターしましょう。</p>
            </div>
